...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
			...
			<td class="info_factura">
				<div class="round">
					<span class="h3">Ticket de Venta</span>
					<p>N°. Ticket: <strong><?php echo $factura['nofactura']; ?></strong></p>
	...
	<div>
		<p class="nota">Si usted tiene preguntas sobre este ticket de venta, <br>póngase en contacto con <?php echo $configuracion['email'] .' o '. $configuracion['telefono']; ?></p>
